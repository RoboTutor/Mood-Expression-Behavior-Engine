...
{
    /// <summary>
    /// TODO: Repeated front pose (flap chest) need to be reworked to improve naturalness.
    /// </summary>
    public class BehaviorProfileMe : BehaviorProfileBase
    {
